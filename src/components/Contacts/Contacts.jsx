                ...
                <section className='contacts page-wrap'>
                    ...
                    <div className="contacts-wrap grid">
                        <div className="contacts-card">
                            ...
                            <a href="mailto:nikolay_vlkv@mail.ru" className="contacts-card__link contacts-card__text">
                        ...
                        <div className="contacts-card">
                            ...
                            <a href="tel:+79965322386" className="contacts-card__link contacts-card__text">
                        ...
                        <div className="contacts-card">
                            ...
                            <div className="contacts-card__links">
                                ...
                                <a className='contacts-card__link' target='_blank'
                                   href="https:/https://www.linkedin.com/in/nikolay-volkov-28552b1a7/"><FontAwesomeIcon
